...
- Треки всех источников собираются вместе, сортируются по дате добавления в исходные плейлисты (свежие сверху) и дедуплицируются - повторяющиеся треки остаются только один раз.
